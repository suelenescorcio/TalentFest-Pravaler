...
function Dice() {
  ...
  return (
    <main className='main-section'>
      ...
      <Input className='input-form' type="text" placeholder={'Nome e Sobrenome'} />
      <Input className='input-form' type="number" placeholder={'Telefone - (12) 34567-8910'} />
      <Input className='input-form' type="email" placeholder={'email@email.com'} />
      ...
      <Input className='input-form uf' type="text" placeholder={'UF'} maxLength="2"/>
      </div>

    <Button
    type="submit" className='button-comparator button-registration'>Cadastre-se</Button>
